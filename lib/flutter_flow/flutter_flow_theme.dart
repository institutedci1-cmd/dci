...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF312E81);
  ...
  late Color accent1 = const Color(0x1A312E81);
  late Color accent2 = const Color(0x1A64748B);
  late Color accent3 = const Color(0x1A8B5CF6);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF818CF8);
  late Color secondary = const Color(0xFF94A3B8);
  late Color tertiary = const Color(0xFFA78BFA);
  ...
  late Color accent1 = const Color(0x1A818CF8);
  late Color accent2 = const Color(0x1A94A3B8);
  late Color accent3 = const Color(0x1AA78BFA);
  late Color accent4 = const Color(0xB20F172A);
  late Color success = const Color(0xFF10B981);
  late Color warning = const Color(0xFFF59E0B);
  late Color error = const Color(0xFFEF4444);
  late Color info = const Color(0xFF818CF8);

  late Color onPrimary = const Color(0xFFFFFFFF);
  late Color primaryContainer = const Color(0xFF1E293B);
  late Color onPrimaryContainer = const Color(0xFFF1F5F9);
  late Color onSecondary = const Color(0xFFFFFFFF);
  late Color secondaryContainer = const Color(0xFF334155);
  late Color onSecondaryContainer = const Color(0xFFF1F5F9);
  late Color onAccent = const Color(0xFF000000);
  late Color accentContainer = const Color(0xFF312E81);
