            ...
            Padding(
              ...
              child: wrapWithModel(
                ...
                child: TextFieldWidget(
                  ...
                  variant: 'outlined',
                  onChange: (val) => safeSetState(() => _searchQuery = val ?? ''),
                ),
              ),
            ),
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  var students = snapshot.data!.docs.map((doc) => doc.data() as Map<String, dynamic>).toList();
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text('ID: ${student['student_id'] ?? 'N/A'} • Class: ${student['class'] ?? 'N/A'}'),
